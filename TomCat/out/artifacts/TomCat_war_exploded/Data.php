...
<body>
<div id="chart1div" style="width: 100%; height: 500px;"></div>
...
<div id="chart2div" style="width: 100%; height: 500px;"></div>
<div style="margin-left:35px;">
    <input type="radio" checked="true" name="group" id="rb3" onclick="setPanSelect()">Select
    <input type="radio" name="group" id="rb4" onclick="setPanSelect()">Pan</div>
</body>
